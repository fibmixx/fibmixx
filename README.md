...
* **Software Engineering Student** at Facultat d'Informàtica de Barcelona (Universitat Politècnica de Catalunya).
* **Web developer** using WordPress for 5 months at inLab FIB.
* **Graduated with Honors** - Dual High School Diploma (Spanish Scientific Baccalaureate (9.0/10 average) & U.S. High School Diploma (3.79 GPA)).
...
`C` · `C++` · `C#` · `Java` · `Python` · `MATLAB` · `OpenGL` · `SQL`

**Tools & Sofware**  
`Github` · `Unity` · `IntelliJ` · `VS Code` · `Aseprite`

**Spoken Languages**  
Catalan (Native) · Spanish (Native) · English (Fluent) · Korean (Learning)
